  ...
  Future<void> submit() async {
    ...
    if (title.length < 5 || description.length < 10) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'Please add a clear title and explain what help you need.',
          ),
        ),
      );
      return;
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const Text(
            'Keep personal information private until you decide to connect with someone.',
          ),
          ...
          TextField(
            ...
            decoration: const InputDecoration(
              ...
              hintText:
                  'Describe the situation and the kind of help that would make a difference.',
          ...
          FilledButton(
            ...
            child: Text(
              loading ? 'PUBLISHING...' : 'ASK THE COMMUNITY',
            ),
          ),
        ],
      ),
